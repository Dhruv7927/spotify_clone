...
const FeaturedSection = () => {
    const {isLoading, featuredSongs, error} = useMusicStores();
        ...
        {featuredSongs.map((song) => (
            ...
            transition-colors group cursor-pointer relative">
                ...
                <div className="flex-1 gap-4">
                    <div className="font-medium truncate ml-2">{song.title}</div>
                    <p className="text-sm text-zinc-400 truncate ml-2">{song.artist}</p>
                </div>
