...
const AddSongDialog = () => {
    ...
    return (
        <Dialog open={SongDialogOpen} onOpenChange={setSongDialogOpen}>
            ...
            <DialogContent className='bg-zinc-900 border-zinc-700 max-h-screen overflow-y-auto'>
                <DialogHeader>
                ...
                <DialogFooter>
                    ...
                    <Button onClick={handleSubmit} disabled={isLoading} className="text-black">
